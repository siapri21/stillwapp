  ...
  return (
    <>
      ...
      <PageMain className="pt-2">
        <h1 className="text-3xl font-semibold text-[var(--sw-text-strong)] md:text-4xl">Matchs parfaits</h1>
        <p className="mt-1 text-sm text-[var(--sw-muted)]">Des étudiants près de toi qui veulent ce que tu proposes.</p>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-2">
                      <div className="overflow-hidden rounded-xl bg-violet-50">
                        ...
                        <div className="p-2">
                          <div className="text-[10px] font-semibold uppercase text-violet-600">Propose</div>
                      ...
                      <div className="overflow-hidden rounded-xl bg-violet-50">
                        ...
                        <div className="p-2">
                          <div className="text-[10px] font-semibold uppercase text-violet-600">Recherche</div>
